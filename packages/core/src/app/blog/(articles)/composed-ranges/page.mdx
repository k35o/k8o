...
description:
createdAt: 2025-08-25 00:00:00.000000+09
updatedAt: 2025-08-25 00:00:00.000000+09
---
...
オプションには`ShadowRoot`オブジェクトの配列を渡します。渡した`ShadowRoot`オブジェクトに含まれる要素であれば、Shadow DOM内の要素であっても選択範囲として検出されます。
...
サンプルテキスト全体に`attachShadow`しています（`closed`）。
