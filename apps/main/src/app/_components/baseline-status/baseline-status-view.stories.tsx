...
const meta: Meta<typeof BaselineStatusView> = {
  title: 'app/globals/baseline-status',
  component: BaselineStatusView,
  args: { feature: widely },
};

export default meta;
type Story = StoryObj<typeof BaselineStatusView>;
