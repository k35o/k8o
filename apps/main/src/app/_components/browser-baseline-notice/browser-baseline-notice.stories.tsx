...
const meta: Meta<typeof BrowserBaselineNotice> = {
  title: 'app/globals/browser-baseline-notice',
  component: BrowserBaselineNotice,
  beforeEach: () => {
...
export default meta;
type Story = StoryObj<typeof BrowserBaselineNotice>;
