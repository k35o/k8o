...
<BrowserSupportStatus featureId="invoker-commands"></BrowserSupportStatus>
...
<PlaygroundEmbed demo="Dialogの操作" sectionId="invoker-commands" />
...
<PlaygroundEmbed demo="Popoverの操作" sectionId="invoker-commands" />
...
<PlaygroundEmbed demo="カスタムコマンド" sectionId="invoker-commands" />
