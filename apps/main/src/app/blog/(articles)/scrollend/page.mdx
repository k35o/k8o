...
<BrowserSupportStatus featureId="scrollend"></BrowserSupportStatus>
...
<PlaygroundEmbed demo="scrollendイベント" sectionId="scrollend" />
...
<PlaygroundEmbed demo="発火条件" sectionId="scrollend" />
