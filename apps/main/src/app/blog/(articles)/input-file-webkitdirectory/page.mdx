...
import {
  BasicFileInputExamples,
  WebkitDirectoryInputExample,
} from './_components/file-input-examples';

# input要素でディレクトリを扱うwebkitdirectory属性

<BrowserSupportStatus featureId="input-file-webkitdirectory" />
...
<PlaygroundEmbed demo="webkitRelativePathの例" sectionId="input-file-webkitdirectory" />
