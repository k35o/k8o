...
import { Alert, BaselineStatus } from '@k8o/arte-odyssey';
...
Firefox 140のリリースで、`CSS Custom Highlight API`がサポートされました。この新機能により、JavaScriptで定義した任意のテキスト範囲をCSSでスタイリングできるようになります。
