...
<BrowserSupportStatus featureId="document-caretpositionfrompoint"></BrowserSupportStatus>
...
<PlaygroundEmbed demo="キャレット位置取得" sectionId="caret-position-from-point" />
...
<PlaygroundEmbed demo="ドラッグ&ドロップ" sectionId="caret-position-from-point" />
