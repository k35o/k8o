...
<BrowserSupportStatus featureId="json-modules"></BrowserSupportStatus>
...
<iframe
  height="300"
  className="writing-h vertical:box-border vertical:mx-4 vertical:max-h-full vertical:max-w-container-2xl w-full"
