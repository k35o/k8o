...
<BrowserSupportStatus featureId="shared-workers" />
...
<PlaygroundEmbed demo="タブ間カウンタ" sectionId="shared-worker" />
...
<BrowserSupportStatus featureId="js-modules-shared-workers" />
