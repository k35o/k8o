...
<BrowserSupportStatus featureId="composed-ranges" />
...
<PlaygroundEmbed demo="Selectionオブジェクトのプロパティ" sectionId="composed-ranges" />
...
<PlaygroundEmbed demo="Selectionオブジェクトのメソッド" sectionId="composed-ranges" />
...
<PlaygroundEmbed demo="Baseline 2025で追加されたgetComposedRangesメソッド" sectionId="composed-ranges" />
