...
<BrowserSupportStatus featureId="popover"></BrowserSupportStatus>
...
<PlaygroundEmbed demo="ツールチップ・ドロップダウン" sectionId="popover" />
...
<PlaygroundEmbed demo="基本的なポップオーバー" sectionId="popover" />
