...
<div className="flex gap-4 flex-col">
  <BrowserSupportStatus featureId="view-transitions" />
  <BrowserSupportStatus featureId="view-transition-class" />
</div>
...
<PlaygroundEmbed demo="View Transition基本デモ" sectionId="view-transitions" />
