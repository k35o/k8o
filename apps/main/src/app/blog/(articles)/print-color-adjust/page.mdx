...
description: print-color-adjustプロパティをexactに設定することで、印刷時にブラウザが自動的に色やコントラストを調整するのを防ぐことができます。印刷時にデザインに意図が伝わらない場合に利用できる有用な機能の一つです。
...
<BrowserSupportStatus featureId="print-color-adjust"></BrowserSupportStatus>
...
<PlaygroundEmbed demo="印刷時の色調整デモ" sectionId="print-color-adjust" />
