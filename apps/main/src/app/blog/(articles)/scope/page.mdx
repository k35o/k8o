...
<BrowserSupportStatus featureId="scope"></BrowserSupportStatus>
...
<PlaygroundEmbed demo="ドーナツスコープ" sectionId="scope" />
...
<PlaygroundEmbed demo=":scopeを使ったスコープリミット" sectionId="scope" />
...
<PlaygroundEmbed demo="スコープの近接性" sectionId="scope" />
