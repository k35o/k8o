...
export const NumberField: FC<Props> = ({
  ...
  return (
    <div
      className={cn(
        'border-border-base bg-bg-base shadow-xs relative flex h-12 w-full items-center justify-between gap-2 rounded-md border',
    ...
    >
      <input
        ...
        className={cn(
          'focus-visible:outline-hidden h-full w-full grow bg-transparent pl-3 pr-8',
