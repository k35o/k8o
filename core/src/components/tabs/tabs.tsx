...
> = ({ label, children }) => {
  ...
  return (
    <div
      ...
      className="border-border-base wrap-normal flex overflow-x-auto overflow-y-hidden border-b p-0.5"
    >
    ...
    children: (
      <>
        {selectedId === id && (
          <motion.div
            layoutId="underline"
            className="bg-primary-border absolute -bottom-0.5 left-0 right-0 h-1"
          />
        )}
        {children}
      </>
