...
このように配置した場合は
![スクリーンショット 2023-04-20 22.06.12.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/591069/680f5d1a-76a9-3369-4f6f-a745e6a2527a.png)
上記のようなアイコンが左下に常に表示され、クリックすることで開発ツールが開かれます。
![スクリーンショット 2023-04-20 22.06.46.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/591069/3b4abc46-9332-59ca-e31d-4f23bc08eb49.png)
